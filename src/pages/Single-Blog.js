					...
					<div className="container box_1620">
						...
						<div className="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul className="nav navbar-nav menu_nav ml-auto">
								...
								<li className="nav-item"><a className="nav-link" href="our-story.html">Our Story  </a></li>
								...
								<li className="nav-item submenu dropdown">
									...
									<ul className="dropdown-menu">
										<li className="nav-item"><a className="nav-link" href="bridesmaid.html">Bridesmaid</a></li>
										<li className="nav-item"><a className="nav-link" href="groomsmen.html">Groomsmen</a></li>
        ...
        <section className="banner_area">
            <div className="banner_inner banner_box d-flex align-items-center">
        ...
        <footer className="footer_area">
        	<div className="container box_1620">
        		<div className="footer_inner p_120">
        			<img src="img/footer-logo.png" alt="">
        			<ul className="list f_menu">
        				<li><a href="#">Home</a></li>
